...
public class WriteBlogController {
	...
	@PostMapping("/newBlog")
	public ModelAndView writeBlog(@AuthenticationPrincipal UserDetails user, @RequestParam String theme, @RequestParam String summary, @RequestParam String content, ModelAndView mav) {
